...
<head>
    <meta charset="utf-8">
    <title>EmpreSys 1.0 - DEPARTAMENTOS</title>
  ...
  <br>
  <center>
    <h1> DEPARTAMENTOS CADASTRADOS NO SISTEMA </h1>
    <center>
      <br>
...
<body class="bg-light">
  ...
  <br>
  <button><a href="cadastrar-dependentes.php" class="btn btn-primary" type="button" name="submit"> CADASTRAR NOVO DEPARTAMENTO </a></button>
